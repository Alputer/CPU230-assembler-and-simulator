...
conflicting_opcodes = ["0C",   "30","32","33",     "34","36", "37",      "3C","3E", "3F",      "40","42", "43"    ,"49","4A", "4B"    ,"4D","4E", "4F"\
,"51","52", "53"    ,"55","56", "57"    ,"59","5A", "5B"    ,"5D","5E", "5F"    ,"61","62", "63"    ,"65","66", "67"    ,"69","6A", "6B",   "6C"]
branch_map = {}
...
def handle_execution(execution_tokens):
	...
	if len(execution_tokens) == 1:
		if token1[: len(token1) - 1] in branch_map.keys(): #branch name. To get around the ":" at the end of label name.
			return
		elif token1 == "HALT":
